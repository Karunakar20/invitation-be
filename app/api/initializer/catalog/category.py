...
class CategoryInitializer:
      ...
      def categotyInitializer(self):
            try:
                  category_path = os.path.join(BASE_DIR, "initializer/data/catalog/category .csv")
                  ...
                  print("Category data has been initialized successfully.")
      ...
      def subCategotyInitializer(self):
            try:
                  ...
                  sub_category_path = os.path.join(BASE_DIR, "initializer/data/catalog/sub_category.csv")
                  ...
                  print("Sub-category data has been initialized successfully.")
